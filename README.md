...
- Willpower - A pool of points that the Spirit can spend to take possession of John or improve its chance of success in any given action. Willpower will go down and up a lot in the game, so it might be easier to represent it with tokens rather than numbers on a page. Willpower starts off at 10 for most Spirits. In Ghosts of John, while John doesn't have a pool of willpower, the GM may make a bid for possession by rolling a concealed d6 to represent John's Willpower.
